import { TabPermission, GroupPermission } from "../redux/tabPermission/tabPermssionSlice";
// import { clientLogger } from '../clientLogger';

// Utility function to check if Tab permission exists
export const checkTabPermissionExists = (tabPermissionMap: Record<string, TabPermission>, permissionName: string, variables?: Record<string, string>): boolean => {
...
export const checkGroupPermissionExists = (groupPermissionMap: Record<string, GroupPermission>, permissionName: string, variables?: Record<string, string>): boolean => {
  let expression: string | undefined;
...
function evaluateExpression(expression: string, variables?: Record<string, string>): boolean {
  try {
