...
import { ShortCodeDetails } from "../../src/interfaces/interfaces"
...
const Agentslice = createSlice({
    ...
    extraReducers(builder) {
        builder.addCase(fetchApiSMSShortCodeDetailsTabData.fulfilled, (state, action) => {
            state.details = action.payload;
        })
        builder.addCase(fetchApiSMSShortCodeDetailsTabData.rejected, (state, action) => {
