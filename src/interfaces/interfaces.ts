...
export type Entity={id: number; endpoint: string; api: string; request: string; response: string; status: string; calledAt: string; completedAt: string; errorMessage: string | null; reqID: string; callTypeID: number; requestDate: string; actionCode: string;}
