...
## 11.0.0
 - upgrade to NEXT 15.2
 - Upgrade to primereact v 10.9.2
 - Upgrade to primeicons v 7.0.0
 - Upgrade to primeflex v 4.0.0
 - Upgrade to typescript v 5.8.2
 - Upgrade to axios v 1.8.1
 - Refactored project files
 - Remove the unused old files & settings.
